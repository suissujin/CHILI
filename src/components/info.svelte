...
<div class="fixed top-0 right-0">
  ...
  >
    ...
    {#if tooltip}
      <div
        role="tooltip"
        class="z-20 absolute cursor-default shadow-lg bg-white p-4 mt-4 rounded right-0 text-black whitespace-nowrap"
      >
        <svg
          class="absolute text-white fill-current -mt-2 mr-1 right-0 top-0"
          width="16px"
          height="9px"
          viewBox="0 0 16 9"
          version="1.1"
        ...
        Wörter können angeklickt und verschoben werden.
      </div>
    {/if}
  </div>
</div>
